...
import { useRouter } from 'next/navigation'; // Required Import
...
const RoleSelectionPage = () => {
    ...
    // Roles array with redirectUrl using BASE_URL
    const roles = [
        { 
            id: 'student', 
            title: 'Student', 
        ...
        <div className="role-main-wrapper">
            <div className="role-selection-box">
                ...
                <div className="role-header-container">
                    <div className="role-logo-circle"><span>✨</span></div>
                    ...
                    {roles.map((role) => (
                        ...
                        >
                            {selectedRole === role.id && (
                                <div className="role-indicator-badge"><span>✓</span></div>
                            )}
